...
def diagnostic(request, pk):
    ...
    if request.method == 'POST':
        ...
        return HttpResponseRedirect(reverse('app:results', kwargs={'pk': pk}))
    return render(request, 'app/diagnostic.html', context)
...
def organisation(request):
    ...
    return render(request, 'app/organisation.html', context)
...
def organisation_form(request):
    ...
    if request.method == 'POST':
        ...
        if organization_form.is_valid():
            ...
            if not same_org:
                ...
                return render(request, 'app/checking_org.html', context)
            return render(request, 'app/checking_org.html', context)
    ...
    return render(request, 'app/organizationform.html', context)
